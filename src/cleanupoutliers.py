def clean_outliers(properties):
    ...
    print("There were", properties[properties['price'] > 2000000].shape[0], "properties with a value of more than 2,000,000€ that have been removed.")
    ...
    print("There were", properties[properties['number of bedrooms'] > 10].shape[0], "properties with more than 10 bedrooms that have been removed.")
    ...
    print("There were", properties[properties['living area'] > 100].shape[0], "properties with a living area greater than 100sqm that have been removed.")
    ...
    print("There were", properties[properties['total property area'] > 750].shape[0], "properties with a total property area greater than 750sqm that have been removed.")
    ...
    print("There were", properties[properties['total land area'] > 20000].shape[0], "properties with a total property land greater than 20000sqm that have been removed.")
    ...
    print("There were", properties[properties['terrace area'] > 250].shape[0], "properties with a terrace area greater than 250sqm that have been removed.")
    ...
    print("There were", properties[properties['number of facades'] > 4].shape[0], "properties with more than 4 facades that have been removed.\n")
